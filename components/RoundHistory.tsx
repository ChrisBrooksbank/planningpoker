        ...
        {reversedHistory.map((entry, displayIndex) => {
          ...
          return (
            ...
            >
              <button
                onClick={() =>
                  setExpandedRound(isExpanded ? null : roundNumber)
                }
              ...
              {isExpanded && (
                <div className="px-3 pb-3 sm:px-4 sm:pb-4 space-y-3">
                  ...
                  <ul
                    className="space-y-1"
                    aria-label={`Round ${roundNumber} votes`}
                  >
                    {voteEntries.map(([userId, { participantName, value }]) => (
                      <li
                        key={userId}
                  ...
                  {/* Statistics summary */}
                  <div
                    className={`grid gap-2 text-center ${showNumericStats ? "grid-cols-3" : "grid-cols-1"}`}
                  >
